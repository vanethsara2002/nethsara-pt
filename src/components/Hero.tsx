      ...
      <div className="container mx-auto px-4 py-20">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-blue-600 dark:text-blue-400 font-semibold mb-4">
            BHSc (Hons) in Biomedical Technology Undergraduate
          </p>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed mb-12">
            A dedicated and tech-savvy Biomedical Technology student with a passion for bridging
            the gap between healthcare and modern technology. Focused on medical instrumentation,
            diagnostic technology, and indigenous medicine's integration with modern science.
          </p>

          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="tel:0788522243"
              className="flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-all duration-300 hover:scale-105 shadow-lg"
            >
              <Phone className="w-5 h-5" />
              <span>0788522243</span>
            </a>
            <a
              href="mailto:vanethsara119@gmail.com"
              className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 hover:scale-105 shadow-lg"
            >
          ...
          <div className="mt-12 flex justify-center gap-6">
            <a
              ...
              className="p-3 bg-white dark:bg-gray-800 rounded-full hover:bg-pink-50 dark:hover:bg-pink-900 transition-all duration-300 hover:scale-110 shadow-lg group"
              aria-label="Instagram"
            >
              <svg className="w-6 h-6 text-pink-600 group-hover:text-pink-700" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 bg-white dark:bg-gray-800 rounded-full hover:bg-blue-50 dark:hover:bg-blue-900 transition-all duration-300 hover:scale-110 shadow-lg group"
              aria-label="Facebook"
            >
